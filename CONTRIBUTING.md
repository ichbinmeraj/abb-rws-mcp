# Contributing to abb-rws-mcp

Thanks for your interest. This project is Apache-2.0 licensed.

This project is in early development. Right now the most useful contributions are:

- Issues describing your controller, RobotWare version and use case
- Reports of RWS behaviour that differs between RobotWare versions or from ABB's
  documentation
...
- The server's offline tests must be green.
